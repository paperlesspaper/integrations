...
export {
  ...
  getQuerySettings,
  getSettings,
  getSettingsFromMessage,
  getSettingsPageHeight,
  hyphenateText,
  hyphenateWord,
  loadLanguageJson,
  markError,
