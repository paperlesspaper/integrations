export const demotivationalQuotesEn = [
  ...
  "Ambition is just anxiety wearing nicer shoes.",
  "Today is full of possibilities, most of them inconvenient.",
  "The reward for hard work is usually more work.",
  "Your future self is probably disappointed already.",
  "Confidence is what happens before the evidence arrives.",
  "A fresh start is just an old mistake in a new outfit.",
  "Your comfort zone misses you, and honestly it has a point.",
  "Progress is just failure with better pacing.",
  "Every plan survives until reality notices it.",
  "The best time to start was yesterday. The second best time is still questionable.",
  "You are one bold decision away from a different problem.",
  "Small steps still count, especially when they are in the wrong direction.",
  "The only thing more reliable than failure is its punctuality.",
  "Motivation fades. Deadlines just get closer.",
  "You can be anything you want, within the narrow limits of circumstance.",
  "Dreams do come true, just rarely yours.",
  "Trying your best is a great way to learn what your best cannot do.",
  "Every door that opens leads to more paperwork.",
  "The path forward is clear, but so is the cliff.",
  "Believe in yourself, because someone has to be wrong.",
  "You are capable of amazing things, mostly by accident.",
  "Your instincts are there to remind you how often guessing fails.",
  "A positive attitude won’t fix the problem, but it will confuse people briefly.",
  "If opportunity knocks, it probably has the wrong address.",
  "Tomorrow is another chance to repeat today with less enthusiasm.",
  "The finish line keeps moving because it knows you are slow.",
  "You are building character, which is what people say when there is no prize.",
  "There is no elevator to success, and the stairs are closed for maintenance.",
  "Your to-do list believes in you more than it should.",
  "The harder you focus, the easier it is to notice everything else going wrong.",
  "Growth is uncomfortable, and stagnation has better seating.",
  "A setback is just a comeback that gave up halfway.",
  "You cannot please everyone, but you can disappoint them evenly.",
  "Your peak performance was probably a typo.",
  "Luck favors the prepared, then wanders off.",
  "Every shortcut has a scenic route through regret.",
  "If it feels impossible, at least your instincts are working.",
  "The universe opens doors, then forgets where it put the hinges.",
  "Your potential is impressive in the same way unopened exercise equipment is.",
  "Keep going. Eventually the problem will be behind you, replaced by another one.",
  "The best version of you is still buffering.",
  "Some days you win. Today has requested a recount.",
  "You are not behind schedule; the schedule was overly optimistic.",
  "Every lesson learned comes with a nonrefundable fee.",
  "The road ahead is paved with good intentions and poor estimates.",
  "You can do hard things, but so can Monday.",
  "Your big break may simply be a crack forming.",
  "If you never give up, the universe may admire your persistence while ignoring it.",
  "Success requires patience, discipline, and a tolerance for anticlimax.",
  "You are closer than ever to finding a new way to fail.",
];
