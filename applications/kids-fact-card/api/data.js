const facts = [
  ...
  },
  {
    ...
    fact: {
      ...
      de: 'Manche Sauropoden hatten Haelse laenger als ein Schulbus und konnten Pflanzen wie lebende Kraene erreichen.',
    },
    detail: {
  ...
  },
  {
    ...
    question: {
      ...
      de: 'Warum koennten auffaellige Platten nuetzlich sein?',
    },
  },
  {
    topic: 'space',
    ...
    fact: {
      ...
      de: 'Ein Tag auf der Venus ist laenger als ein Venusjahr. Sie dreht sich so langsam, dass der Sonnenaufgang sehr lange dauert.',
    },
    detail: {
    ...
    question: {
      ...
      de: 'Was wuerdest du mit einem Tag machen, der laenger als ein Jahr ist?',
    },
  },
  {
    topic: 'space',
  ...
  },
  {
    ...
    detail: {
      ...
      de: 'Astronauten liessen Reflektoren auf dem Mond, damit Forschende die Entfernung mit Lasern messen koennen.',
    },
    question: {
  ...
  },
  {
    ...
    detail: {
      ...
      de: 'Astronautinnen und Astronauten nutzen Funk, weil Radiowellen durch den Weltraum reisen koennen.',
    },
    question: {
      en: 'How would you communicate without sound?',
      de: 'Wie wuerdest du dich ohne Schall verstaendigen?',
    },
  },
  {
    topic: 'space',
  ...
  },
  {
    ...
    fact: {
      ...
      de: 'Fussspuren auf dem Mond koennen sehr lange bleiben, weil es dort keinen Wind und keinen Regen gibt, der sie wegwischt.',
    },
    detail: {
      en: 'Tiny space rocks can still slowly disturb the surface.',
      de: 'Winzige Weltraumsteine koennen die Oberflaeche aber langsam veraendern.',
    },
    question: {
  ...
  },
  {
    ...
    fact: {
      ...
      de: 'Honigbienen koennen einen Schwaenzeltanz machen, der anderen Bienen zeigt, wo gutes Futter ist.',
    },
    detail: {
  ...
  },
  {
    ...
    fact: {
      ...
      de: 'Pinguine koennen nicht durch die Luft fliegen, aber ihre Flossen funktionieren unter Wasser wie Fluegel.',
    },
    detail: {
    ...
    question: {
      ...
      de: 'Wuerde Schwimmen anders sein, wenn deine Arme Fluegel waeren?',
    },
  },
  {
    topic: 'animals',
    ...
    fact: {
      ...
      de: 'Elefanten koennen sehr tiefe Rumpellaute nutzen, die weit durch Luft und sogar durch den Boden reisen.',
    },
    detail: {
  ...
  },
  {
    ...
    fact: {
      ...
      de: 'Seeotter koennen Steine wie Werkzeuge benutzen, um Muscheln zu knacken, waehrend sie auf dem Ruecken treiben.',
    },
    detail: {
...
function normalizeTopic(value) {
  const topic = String(value || 'mixed').trim().toLowerCase();
  return supportedTopics.includes(topic) ? topic : 'mixed';
}

function normalizeLanguage(value) {
  const requested = String(value || 'en').trim().toLowerCase();
...
export default async function handler({ query = {} } = {}) {
  ...
  const pool = topic === 'mixed' ? facts : facts.filter((fact) => fact.topic === topic);
