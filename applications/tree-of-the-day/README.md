...
- `treeId`: pin a tree by slug. The catalog contains `coast-redwood`, `african-baobab`, `dragon-blood-tree`, `ginkgo`, `jaya-sri-maha-bodhi`, `olive-tree`, `norway-spruce`, `major-oak`, `wollemi-pine`, `giant-sequoia`, `general-sherman`, `bristlecone-pine`, `banyan`, `japanese-cherry`, `date-palm`, `kapok`, `european-yew`, `angel-oak`, `monkey-puzzle`, `rainbow-eucalyptus`, `joshua-tree`, `quiver-tree`, `red-mangrove`, and `silver-birch`.
